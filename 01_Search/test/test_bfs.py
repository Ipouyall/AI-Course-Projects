...
class TestSearchBFS(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.result, self.visited, self.path = search.bfs(
            start_state,
            goal_test,
...
class TestSearchBFS2(unittest.TestCase):
    def setUp(self) -> None:
...
class TestSearchBFS3(unittest.TestCase):
    def setUp(self) -> None:
