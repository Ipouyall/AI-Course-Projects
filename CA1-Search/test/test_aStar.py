...
class TestSearchAStar(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.result, self.visited, self.path = \
            search.a_star(start_state, goal_test, self.graph.get_transition_function(),
                          search.generate_path_base_heuristic(self.graph))
...
class TestSearchAStar2(unittest.TestCase):
    def setUp(self) -> None:
...
class TestSearchAStar3(unittest.TestCase):
    def setUp(self) -> None:
